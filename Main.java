...
public class Main {
	...
	public static void inventoryTable(Database data) {
		String notDone = "";
		while (notDone != "N") {
	...
	public static void usersTable(Database data) {
	...
	public static void ordersTable(Database data) {
		String notDone = "";
		while(notDone != "N") {
		System.out.println("Would you like to edit your CSV file? (Y/N)");
		String editReply = input.nextLine();
        ...
        System.out.println("[G] to generate report with filter");
				...
				if(editOption.contentEquals("S")) {
					...
					data.insertOrders(cust_email, cust_location, product_id, quantity);
				} else if(editOption.contentEquals("D")) {
					System.out.println("-----------Delete Entry-----------");
					System.out.println("Order ID: ");
					String order_id = input.nextLine();
					data.deleteOrders(order_id);
